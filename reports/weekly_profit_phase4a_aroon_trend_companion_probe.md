...
`aroon_break_hh_4h_trending_up_frequency_companion` generated 4 synthetic candidates and hit 0 silent zero-entry weeks.
...
| candidates by dominant regime | `{"RANGING": 4}` |
| candidates by packet state | `{"investigate": 4}` |
