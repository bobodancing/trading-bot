...
- Summary artifact: `C:\Users\user\Documents\tradingbot\strategy-runtime-reset\extensions\Backtesting\results\portfolio_ab_risk_sensitivity\risk_0p020\slot_a_b\portfolio_ab_matrix_summary.json`
...
| --- | ---: | ---: | --- |
| portfolio max_dd_pct | 5.1162 | 8.0000 | PASS |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| `TRENDING_UP` | 32 | 1757.4217 | 4.3144 | 0 | 0 |
| `RANGING` | 3 | 89.0764 | 0.8976 | 0 | 0 |
...
| `TRENDING_UP` | Slot B | 6 | 272.9132 | 0.8119 | 0 |
| `RANGING` | Slot A | 1 | -45.2810 | 0.4528 | 0 |
| `RANGING` | Slot B | 2 | 134.3574 | 0.0000 | 0 |
...
| window | trades | net_pnl | portfolio_max_dd_pct | run_errors | same_symbol_same_candle_overlaps |
| --- | ---: | ---: | ---: | ---: | ---: |
| `bull_strong_up_1` | 11 | 755.9849 | 2.4695 | 0 | 0 |
...
| `classic_rollercoaster_2021_2022` | 50 | 2999.2424 | 5.1162 | 0 | 0 |
| `recovery_2023_2024` | 65 | 3281.2596 | 4.1090 | 0 | 0 |
...
| `bull_strong_up_1` | Slot B | 5 | 160.2806 | 0.4409 | 0 |
...
| `classic_rollercoaster_2021_2022` | Slot A | 25 | 1757.9389 | 3.4235 | 0 |
| `classic_rollercoaster_2021_2022` | Slot B | 25 | 1241.3034 | 2.0945 | 0 |
| `recovery_2023_2024` | Slot A | 45 | 2245.5016 | 4.4591 | 0 |
| `recovery_2023_2024` | Slot B | 20 | 1035.7580 | 0.7840 | 0 |
