...
- Summary artifact: `C:\Users\user\Documents\tradingbot\strategy-runtime-reset\extensions\Backtesting\results\portfolio_ab_risk_sensitivity\risk_0p014\slot_a_b\portfolio_ab_matrix_summary.json`
...
| --- | ---: | ---: | --- |
| portfolio max_dd_pct | 4.7786 | 8.0000 | PASS |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| `TRENDING_UP` | 32 | 1773.9424 | 4.2730 | 0 | 0 |
| `RANGING` | 3 | 64.0414 | 0.8997 | 0 | 0 |
...
| --- | --- | ---: | ---: | ---: | ---: |
| `TRENDING_UP` | Slot A | 26 | 1488.4486 | 3.0588 | 0 |
| `TRENDING_UP` | Slot B | 6 | 285.4938 | 0.6889 | 0 |
| `RANGING` | Slot A | 1 | -45.2810 | 0.4528 | 0 |
| `RANGING` | Slot B | 2 | 109.3225 | 0.0000 | 0 |
...
| window | trades | net_pnl | portfolio_max_dd_pct | run_errors | same_symbol_same_candle_overlaps |
| --- | ---: | ---: | ---: | ---: | ---: |
| `bull_strong_up_1` | 11 | 733.2859 | 2.4695 | 0 | 0 |
...
| `classic_rollercoaster_2021_2022` | 50 | 2507.5215 | 4.7786 | 0 | 0 |
| `recovery_2023_2024` | 65 | 3260.2163 | 4.0809 | 0 | 0 |

## Supplemental Per-Cartridge

| window | slot | trades | net_pnl | realized_trade_dd_pct | entry_stop_violations |
| --- | --- | ---: | ---: | ---: | ---: |
| `bull_strong_up_1` | Slot A | 6 | 598.0403 | 1.0197 | 0 |
| `bull_strong_up_1` | Slot B | 5 | 135.2456 | 0.4409 | 0 |
...
| `classic_rollercoaster_2021_2022` | Slot A | 25 | 1456.1486 | 3.2445 | 0 |
| `classic_rollercoaster_2021_2022` | Slot B | 25 | 1051.3729 | 1.5296 | 0 |
| `recovery_2023_2024` | Slot A | 45 | 2216.5115 | 4.4396 | 0 |
| `recovery_2023_2024` | Slot B | 20 | 1043.7049 | 0.6652 | 0 |
