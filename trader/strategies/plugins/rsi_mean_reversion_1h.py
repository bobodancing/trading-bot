"""RSI mean reversion long-only research cartridge on 1h."""
...
class RsiMeanReversion1hStrategy(StrategyPlugin):
    id = "rsi_mean_reversion_1h"
    version = "0.1.0"
    tags = {"external_candidate", "rsi", "bollinger", "1h", "long_only", "mean_reversion"}
