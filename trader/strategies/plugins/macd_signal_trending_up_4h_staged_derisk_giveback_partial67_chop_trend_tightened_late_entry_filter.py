"""Partial67 chop-trend localization pass with a tighter late-entry veto."""
...
class MacdSignalTrendingUp4hStagedDeriskGivebackPartial67ChopTrendTightenedLateEntryFilterStrategy(
    ...
    id = (
        ...
        "chop_trend_tightened_late_entry_filter"
    )
    version = "0.1.0"
    ...
    params_schema = {
        **MacdSignalTrendingUp4hStagedDeriskGivebackPartial67Strategy.params_schema,
        ...
        "chop_trend_extension_atr_trigger": "float",
    }
    ...
    def generate_candidates(self, context: StrategyContext) -> list[SignalIntent]:
        ...
        extension_trigger = float(
            self.params.get("chop_trend_extension_atr_trigger", 1.5)
        )
        chop_trend_active = (
            chop_metrics["adx_slope_5"] < 0.0
            and chop_metrics["bbw_ratio"] < entry_bbw_ratio_min
        )
        # Require a more extreme chase before the noisy chop proxy can veto.
        tightened_veto_active = (
            chop_trend_active
            and extension_atr > extension_cap
            and extension_atr >= extension_trigger
        )
            ...
            replace(
                ...
                metadata={
                    **intent.metadata,
                    ...
                    "weak_tape_chop_trend_extension_atr_trigger": extension_trigger,
                },
            )
