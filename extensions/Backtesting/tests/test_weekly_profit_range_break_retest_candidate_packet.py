...
from extensions.Backtesting.scripts.analyze_weekly_profit_range_break_retest_candidate_packet import (
    build_range_break_retest_candidate_packet_payload,
)
...
def test_range_break_retest_candidate_packet_compares_against_phase3_baseline(tmp_path) -> None:
    ...
    assert payload["schema"] == "strategy_plugin_weekly_profit_range_break_retest_candidate_packets.v1"
