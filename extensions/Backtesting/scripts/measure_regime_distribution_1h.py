"""Measure ADX regime distribution for 1h BTC/ETH across review windows."""
...
TIMEFRAME = "1h"
ADX_LENGTH = 14
REPORT_PATH = REPO_ROOT / "reports" / "regime_distribution_baseline_1h.md"
...
def write_report(rows: list[dict]) -> Path:
    ...
    lines.extend([
        ...
        "",
        (
            "BTC/USDT uses `adx < 25` on 1h for "
        ...
        (
            "ETH/USDT uses `adx < 25` on 1h for "
